        ...
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
            <div className="max-w-sm mx-auto w-full md:w-3/4 lg:w-1/2 xl:w-1/3">
                <div className="flex flex-col md:flex-row justify-between items-center mb-8">
                    <div className="space-x-2 mt-2 md:mt-0"></div>
                </div>
                ...
                <button onClick={handleStartChatting} className="bg-white text-black font-bold w-full py-3 rounded-full mb-4">
                    Start Chatting
                </button>
                <button className="text-zinc-400 px-[7rem] text-center">View Terms & Conditions</button>
            </div>
        </div>
    );
}
